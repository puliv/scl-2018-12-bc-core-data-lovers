...
describe('championManage.averageStats', () => {
  ...
  it('Debería devolver el promedio de cada stat de todos los champions al aplicar championManage.averageStats(championData), valor de 550.1820895522388', () => {
    //aquí va el assert;
  });

  // calculo con filtros a la data
  it('Debería devolver el promedio de cada stat de todos los champions tipo "Mage" al aplicar championManage.averageStats(championManage.filterData(championData), valor de 528.3900000000001)', () => {
    //aquí va el assert;
  });
